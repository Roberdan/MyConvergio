...
const OS_ICON = {
  ...
  linux: _SVG(
    '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9v-2h2v2zm0-4H9V7h2v5zm4 4h-2v-2h2v2zm0-4h-2V7h2v5z"/><path d="M12.5 2.05A10 10 0 0 1 22 12a10 10 0 0 1-9.5 9.95V19.9A8 8 0 0 0 20 12 8 8 0 0 0 12.5 4.05V2.05z" fill="none"/><circle cx="10" cy="9" r="1.2"/><circle cx="14" cy="9" r="1.2"/><path d="M12 17c-1.5 0-2.7-.9-3.2-2.1h6.4c-.5 1.2-1.7 2.1-3.2 2.1z"/>',
  ),
  windows: _SVG(
