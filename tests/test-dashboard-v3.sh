...
$PYTHON -c "from dashboard_textual.app import ControlCenterApp" 2>/dev/null && pass "Python app import" || fail "Python app import"
$PYTHON -c "from dashboard_textual.themes import THEMES, THEME_NAMES" 2>/dev/null && pass "Python themes import" || fail "Python themes import"
cd "$ROOT_DIR"
