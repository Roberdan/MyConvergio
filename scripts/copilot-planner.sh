...
Copilot CLI wrapper for the planner agent.

Examples:
  copilot-planner.sh "Create a rollout plan for auth hardening"
  copilot-planner.sh --print "Plan a dashboard refactor"
EOF
}
