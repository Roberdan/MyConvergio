...
init_db() {
  mesh_test_create_db "$DB" "
    ...
    CREATE TABLE IF NOT EXISTS coordinator_claim (
...
sqlite3 "$DB" "INSERT INTO peer_heartbeats(peer_name,last_seen) VALUES ('peer-offline', $(($(now_epoch)-1000)));"
sqlite3 "$DB" "INSERT INTO plans(id,status,execution_host) VALUES (1,'doing','peer-offline');"
...
sqlite3 "$DB" "INSERT INTO peer_heartbeats(peer_name,last_seen) VALUES ('peer-recovered', $(($(now_epoch)-2000)));"
...
sqlite3 "$DB" "INSERT INTO peer_heartbeats(peer_name,last_seen) VALUES ('peer-z', $(($(now_epoch)-4000)));"
sqlite3 "$DB" "INSERT INTO tasks(id,status,executor_host,assigned_at) VALUES (1,'in_progress','peer-z', $(($(now_epoch)-1900)));"
check_reassign_threshold
