...
description: "Feature completion workflow manager. Analyzes open GitHub issues, verifies implementation status, updates documentation, and closes completed features. NOT for version releases (use app-release-manager)."
tools: []
color: "#27AE60"
model: "sonnet"
version: "1.0.3"
