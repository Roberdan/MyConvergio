...
- `/Users/roberdan/.claude/rules/agent-discovery.md` - Agent discovery and routing patterns
- `/Users/roberdan/.claude/PLANNER-ARCHITECTURE.md` - Plan execution architecture
- `/Users/roberdan/.claude/commands/planner.md` - Planner skill documentation
