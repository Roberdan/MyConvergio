...
tools: ["Task", "Read", "Write", "Bash", "Glob", "Grep", "WebSearch", "TodoRead", "TaskCreate", "TaskList", "TaskGet", "TaskUpdate", "TodoCreate", "TodoUpdate", "TodoDelete", "TodoSearch", "NotifySchedule", "NotifyCancel", "MCPCall"]
color: "#9B59B6"
model: "haiku"
version: "1.0.2"
memory: user
