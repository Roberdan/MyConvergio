...
const OS_ICON = {
  ...
  linux: _SVG(
    '<path d="M12 2C9.8 2 8 3.8 8 6c0 .7.2 1.4.5 2C7 8.5 5.5 10 5.5 12c0 1.5.8 2.8 2 3.5-.3.5-.5 1-.5 1.5 0 1.5 1 2.8 2.5 3.3.2.1.3.2.5.2h4c.2 0 .3-.1.5-.2C16 19.8 17 18.5 17 17c0-.5-.2-1-.5-1.5 1.2-.7 2-2 2-3.5 0-2-1.5-3.5-3-4 .3-.6.5-1.3.5-2 0-2.2-1.8-4-4-4zm-2 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm4 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.5 3h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1z"/>',
  ),
  windows: _SVG(
    '<path d="M3 12V6.5l8-1.1V12H3zm0 .5h8v6.6l-8-1.1V12.5zM11.5 5.3 21 3.8V12h-9.5V5.3zm0 7.2H21v8.2l-9.5-1.5V12.5z"/>',
  ),
  unknown: _SVG(
